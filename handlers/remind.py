...
from utils.schedulers import create_time, add_send_message, \
...
async def confirm_to_remove_remind(call: CallbackQuery,
...
@remind.callback_query(RemindState.start,
                       F.data.in_(["add_remind", "change_remind"]))
